...
<div class="max-w-7xl mt-5 container mx-auto grid grid-cols-2 gap-8">
    @forelse($categories as $category)
        <div class="relative h-64">
            <a href="{{ route('category.show', $category->id) }}">
                <div class="absolute inset-0">
                    <img class="w-full h-full object-cover rounded-md" src="{{ asset("storage/images/" . $category->category_image) }}" alt="{{ $category->name }}" />
                    <div class="absolute inset-0 bg-black opacity-50 rounded-md"></div>
                </div>
            
            <div class="absolute inset-0 flex flex-col justify-center items-center text-center">
                <h2 class="text-white text-3xl font-bold shadow-md">{{ $category->name }}</h2>
            </div>
            </a>
        </div>
    @empty
    ...
    <div class="relative h-64">
            <a href="{{ route('listing.index') }}">
                <div class="absolute inset-0">
                    <img class="w-full h-full object-cover rounded-md" src="{{ asset("storage/images/appleEcosystem.jpg") }}" />
                    <div class="absolute inset-0 bg-black opacity-50 rounded-md"></div>
                </div>
            
            <div class="absolute inset-0 flex flex-col justify-center items-center text-center">
                <h2 class="text-white text-3xl font-bold shadow-md">View All</h2>
            </div>
            </a>
        </div>
</div>
