<x-app-layout>
    ...
    <div class="py-5">
        <div class="max-w-7xl mx-auto">
            <div class="flex container mx-auto px-4 ml-1 mb-5 justify-between">
                <div>
                    <a href="{{ route('listing.create') }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Create Listing</a>
